...
export function RunSessionProvider({ children }: { children: ReactNode }) {
  ...
  const actions = useMemo(
    () => ({
      ...
      handleUpdateProsperoRegistration: value.handleUpdateProsperoRegistration,
      handleRegenerateProsperoDocs: value.handleRegenerateProsperoDocs,
    ...
    [
      ...
      value.handleUpdateProsperoRegistration,
      value.handleRegenerateProsperoDocs,
