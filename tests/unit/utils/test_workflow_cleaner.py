...
from src.utils.workflow_cleaner import CleanupReport, WorkflowCleaner, WorkflowFolder
...
class TestWorkflowCleaner:
    ...
    def test_parse_folder_name_valid(self, cleaner):
        ...
        result = cleaner.parse_folder_name(
            "workflow_financial_trading_system_integ_20260122_163807"
        )
        assert result is not None
        ...
        report = CleanupReport(
            ...
            topic_details={
                "topic1": {
                    ...
                    "checkpoint_folders": [
                        {"name": "workflow_topic1_20260120_144424", "size_mb": 5.0}
                    ],
