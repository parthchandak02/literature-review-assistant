...
@pytest.mark.parametrize(
    ("phase", "expected"),
    [
        ("phase_2_search", PHASE_ORDER[1:]),
        ("phase_3_screening", PHASE_ORDER[2:]),
        ("phase_4_extraction_quality", PHASE_ORDER[3:]),
        ("phase_4b_embedding", PHASE_ORDER[4:]),
        ("phase_5_synthesis", PHASE_ORDER[5:]),
        ("phase_5b_knowledge_graph", PHASE_ORDER[6:]),
        ("phase_5c_pre_writing_gate", PHASE_ORDER[7:]),
        ("phase_6_writing", PHASE_ORDER[8:]),
        ("phase_7_audit", PHASE_ORDER[9:]),
        ("finalize", ["finalize"]),
    ],
)
