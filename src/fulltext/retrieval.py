"""Tiered full-text retrieval for systematic review papers."""
...
# Public alias for landing-page resolution (used by PDFRetriever fallback path).
resolve_landing_page = _resolve_landing_page
