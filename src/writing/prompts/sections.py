...
def get_methods_prompt_context(
    ...
    return (
        ...
        "(2) Information sources (list ONLY the databases shown in the block -- "
        "do NOT add Scopus/Web of Science/CINAHL unless listed), "
        "(3) Search strategy (reference the search appendix), "
        "(4) Selection process (dual AI reviewer screening with automated adjudication), "
