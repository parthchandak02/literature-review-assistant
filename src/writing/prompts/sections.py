...
def get_methods_prompt_context(
    ...
    return (
        ...
        "(4) Selection process: clearly state 'two independent reviewers screened titles and abstracts, "
        "with disagreements resolved by a third reviewer.' "
        "Do NOT use 'human' or 'AI' when describing reviewers; use 'reviewers' or 'independent reviewers' only. "
        "If full-text assessment was also performed, state that two independent reviewers assessed full texts. "
        ...
        "If the block shows a TODO placeholder, include it verbatim. "
