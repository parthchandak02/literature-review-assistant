...
def get_methods_prompt_context(
    ...
    return (
        ...
        "This correctly describes the AI-assisted dual-reviewer process. "
        "Do NOT write 'two human reviewers', 'two independent researchers', or any phrasing that implies "
        "human reviewers performed screening. The block contains the exact approved description. "
