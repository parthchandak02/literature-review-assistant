...
def get_results_prompt_context(
    ...
    return (
        ...
        "When reporting these reasons, state explicitly that reason categories may overlap and "
        "one article can contribute to multiple reason counts; do NOT imply reason counts are "
        "separate article totals.\n"
