...
Usage:
    uv run python scripts/repair.py finalize --run-dir <path-to-run-directory>

Example:
    uv run python scripts/repair.py finalize \\
...
async def run_finalize(run_dir: str) -> int:
    return await main(run_dir)
