...
from src.testing.stage_validators import ChartValidator, CitationValidator, StageValidatorFactory
...
def test_stage(
    ...
    try:
        ...
        if test_citations and stage in ["writing", "report"]:
            ...
            papers_data = [
                p.__dict__ if hasattr(p, "__dict__") else p for p in manager.final_papers
            ]
