...
## Fireworks / protocol generation timeout after Phase 2
...
Approximately 10 papers/minute during dual-review (Fireworks flash-0731 batch LLM calls). For 3,000 papers expect 20-30 minutes for Phase 3. The tmux progress bar goes stale — query the runtime DB directly for real status:
